...
func BenchmarkBoneXMux(b *testing.B) {
	...
	muxx.Get("/", func(rw http.ResponseWriter, req *http.Request, arg Args) {
		rw.Write([]byte("b"))
	})
	muxx.Get("/a", func(rw http.ResponseWriter, req *http.Request, arg Args) {
		rw.Write([]byte("b"))
	})
	muxx.Get("/aas", func(rw http.ResponseWriter, req *http.Request, arg Args) {
		rw.Write([]byte("b"))
	})
	muxx.Get("/sd", func(rw http.ResponseWriter, req *http.Request, arg Args) {
		rw.Write([]byte("b"))
	})
